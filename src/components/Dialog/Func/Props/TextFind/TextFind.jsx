		...
		<Grid 
			...
			<Grid
				...
				<InputText
					...
					defaultValue={prop1}
					name="prop-1"
					label={getLang('cmpDialogFuncPropsTextFindTextSplice')}
					placeholder={getLang('cmpDialogFuncPropsTextFindTExtOrNumber')}
					helperText={getLang('cmpDialogFuncPropsTextFindSelectProp')} />
			</Grid>
			<Grid
				item
				xs={4}>
				<InputText
					...
					defaultValue={prop2}
					name="prop-2"
					label={getLang('cmpDialogFuncPropsTextFindValue')}
					placeholder={getLang('cmpDialogFuncPropsTextFindSymbol')}
					helperText={getLang('cmpDialogFuncPropsTextFindSelectProp2')} />
			</Grid>
		</Grid>
	</React.Fragment>;
};
