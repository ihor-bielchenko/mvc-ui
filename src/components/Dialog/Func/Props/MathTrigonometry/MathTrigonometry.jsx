		...
		<Grid
			...
			<Grid
				...
				<InputNumeric
					...
					defaultValue={prop2}
					name="prop-2"
					label={getLang('cmpDialogFuncPropsMathTrigonomValue')}
					placeholder={getLang('cmpDialogFuncPropsMathTrigonomNumb')}
					helperText={getLang('cmpDialogFuncPropsMathTrigonomSelectProp')} />
			</Grid>
		</Grid>
	</React.Fragment>;
};
