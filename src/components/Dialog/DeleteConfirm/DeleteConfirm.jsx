...
let DeleteConfirm = () => {
	...
	const _title = ((dialog || {}).title) || getLang('cmpDialogDeleteComfirmAreShure');
	const _handleText = ((dialog || {}).handleText) || getLang('cmpDialogDeleteComfirmRem');
			...
			<DialogActions>
				<Box 
					...
					<Button 
						...
						{getLang('cmpDialogDeleteComfirmCancel')}
					</Button>
				</Box>
			</DialogActions>
		</Dialog>
