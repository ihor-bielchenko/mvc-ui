	...
	const raw = Object.keys(process.env)
		...
		.reduce(
			...
			},
			{
				...
				MODEL_STATUS_ACTIVE: Number(process.env.MODEL_STATUS_ACTIVE),
				MODEL_STATUS_DISABLED: Number(process.env.MODEL_STATUS_DISABLED),
				MODEL_STATUS_DELETED: Number(process.env.MODEL_STATUS_DELETED),

				SERVER_STATUS_INIT: Number(process.env.SERVER_STATUS_INIT),
				SERVER_STATUS_BUILDED: Number(process.env.SERVER_STATUS_BUILDED),
				SERVER_STATUS_RUN: Number(process.env.SERVER_STATUS_RUN),
				SERVER_STATUS_RESTART: Number(process.env.SERVER_STATUS_RESTART),
				...
				FUNC_TEMPLATE_HASH_BASE64_ENCODE: Number(process.env.FUNC_TEMPLATE_HASH_BASE64_ENCODE),
				FUNC_TEMPLATE_HASH_BASE64_DECODE: Number(process.env.FUNC_TEMPLATE_HASH_BASE64_DECODE),
